        ...
        <div className="zone-contenu">
          ...
          <div className="ligne-1">
            ...
            <div className="nouvelle-facture-gauche">
              ...
              <div className="input-information-client">
                <div className="client-ligne-1">
                  <InputV2 label="Nom / Société" type="" placeholder="" />
                </div>
            ...
            <div className="nouvelle-facture-droite">
              {/* Date */}
              <div className="Date">
                <div className="titre-section-dates">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                    fill="currentColor" viewBox="0 0 24 24" >
                ...
                <div className="input-information-dates">
                  <Input label="Date d'émission" type="" placeholder="" />
                  <Input label="Date d'échéances" type="" placeholder="" />
                </div>
              </div>

              {/* Factures */}
              <div className="Factures">
                <div className="titre-section-facture">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                    fill="currentColor" viewBox="0 0 24 24" >
                  ...
                  <h2>Numéro de factures</h2>
                </div>

                <div className="input-information-facture">
                  <InputV2 label="Numéro de facture" type="" placeholder="Le numéro sera attribué lors de l'émission" />
                </div>
              </div>
            </div>
          </div>
