...
const detailsFactures: React.FC = () => {
    const navigate = useNavigate();

    return (

        <div className="page-conteneur-factures">
            {/* Importation SideBar */}
            <Sidebar />

            <div className="page-contenu-factures">
                {/* Importation Header */}
                ...
                <div className="zone-contenu-details-factures">
                    ...
                    <div className="details-factures-droite">
                        {/* Statut */}
                        <div className="details-factures-droite-statut">
                        ...
                        {/* Historique */}
                        <div className="details-factures-droite-historique">
                            <div className="titre-section">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                    fill="currentColor" viewBox="0 0 24 24" >
                                    <path d="M19 4h-2V2h-2v2H9V2H7v2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2M5 20V8h14V6v14z"></path><path d="M12 13h5v5h-5z"></path>
