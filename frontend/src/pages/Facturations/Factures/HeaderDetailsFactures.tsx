...
import './HeaderDetailsFactures.css';


// ------------------------------ Propriétés du composant Header ------------------------------
interface ProprieteHeaderDetailsFactures {
    ...
    return (
        <div className="header-details-devis-contenu">
            ...
            <div className="header-details-devis-top">
                ...
                {/* Actions de droite */}
                <div className="header-details-factures-actions">


                    {/* Bouton favori (étoile) */}
                    <button
                        className={`header-details-factures-btn-favori ${favoriLocal ? 'active' : ''}`}
                        onClick={() => {
            ...
            <div className="header-details-factures-sous-titre">

                {/* Badge statut brouillon */}
                <span className="header-details-factures-badge">
            ...
            {/* Séparateur */}
            <hr className="header-details-factures-separateur" />

        </div>
    );
};

export default HeaderDetailsFactures;