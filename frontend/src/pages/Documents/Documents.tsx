...
import Header from './headerDocuments'; // Import header documents
import Sidebar from "../../assets/composants/Sidebar" // Import SideBar
import './Documents.css'; // CSS de la page documents
...
const Devis: React.FC = () => {
    ...
    // Fonction déclanchée pour créer un nouveau document
    const NouvelleFacture = () => {
        console.log('réer un nouveau document');
        // [Ajouter la logique pour créer un nouveau document
    };
    ...
    return (
        <div className="page-conteneur">
            ...
            <div className="page-contenu">
                {/* Header */}
                <Header
                    titre="Documents"                           // changer le titre de la page
